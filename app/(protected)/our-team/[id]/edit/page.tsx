// app/(protected)/our-team/[id]/edit/page.tsx
'use client';
...
import { getTeamMember, updateTeamMember } from '@/lib/teamApi';
        ...
        getTeamMember(id)
            .then(data => {
                setFormData({
                    ...
                    relationToGroup: data.relationToGroup || '',
                    linkedin: data.socialLinks.linkedin || '',
                    instagram: data.socialLinks.instagram || '',
                    facebook: data.socialLinks.facebook || '',
                    taglineThought: data.taglineThought || '',
    ...
    if (loading) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh] gap-3">
                ...
                <p className="text-sm text-slate-400 font-medium">Loading member data…</p>
            </div>
        );
    }
                ...
                <div className="lg:col-span-4 space-y-6">
                    <div className="bg-white p-6 border border-slate-100 shadow-sm rounded-sm">
                        ...
                        <p className="mt-4 text-[11px] text-slate-400 text-center leading-relaxed">
                            Click to change photo. Recommended: Square image.
                        </p>
                    </div>
                </div>
