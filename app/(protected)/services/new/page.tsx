...
import { 
    ...
    CheckSquare, TrendingUp, Gavel, Plus, Trash2
} from 'lucide-react';
        ...
        <div className="min-h-[calc(100vh-64px)] bg-[#f9fbfd]">
            ...
            <div className="bg-white border-b border-slate-100 px-4 lg:px-8 py-5">
                <div className="flex items-center gap-1.5 mb-3 text-xs text-slate-400 font-medium">
                    ...
                    <span className="text-slate-700 font-semibold truncate max-w-[200px]">New Service</span>
                </div>

                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                    <div>
                        <h1 className="text-xl font-bold text-slate-900 leading-tight">Create Service</h1>
                        <p className="text-sm text-slate-400 mt-0.5">Add a new construction or consultation service to showcase</p>
                    </div>
                    ...
                    >
                        {submitting ? <><Loader2 size={14} className="animate-spin" /> Publishing…</> : <><Save size={14} /> Publish Service</>}
                    </button>
                </div>
            </div>
