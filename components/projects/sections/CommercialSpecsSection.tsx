// components/projects/sections/CommercialSpecsSection.tsx
'use client';
...
export default function CommercialSpecsSection({ project, onUpdate }: Props) {
    ...
    return (
        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-4 sm:p-6 space-y-4 w-full">
            <div>
                <h2 className="text-base font-bold text-slate-800">Commercial Specifications</h2>
                <p className="text-xs text-slate-400 mt-0.5">
                    Pricing, payment plans, possession dates and other commercial details
                </p>
            </div>
            ...
            <div className="border border-slate-100 rounded-xl overflow-x-auto">
                ...
                {items.length === 0 ? (
                    <div className="py-10 text-center text-sm text-slate-400">
                        No commercial specs yet — click &quot;Add Row&quot; below
                    </div>
                ) : (
                    items.map((item, i) => (
